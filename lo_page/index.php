...
<head>
    ...
    <title>Justyn Larry Mortgages | Home</title>
</head>
...
<div class="main-body">
    ...
    <!-- Contact and submission form section -->
        ...
        <div class="photo-container">
            <img src="images/jml_counter.jpg" alt="Justyn at the coffee shop" height="100%" width="auto">
        </div>
    </div>
...
<footer>
    ...
    <div class="footer-contact">
        <h5>JUSTYN LARRY</h5>
        <h5>Loan Originator, NMLS #1628121</h5>
        <li>Strong Financial Group, Inc.</li>
        <li>7350 East Progress Place, Suite #100</li>
    ...
    <div class="footer-links">
        ...
        <li><a href="https://strongfg.my1003app.com/1628121/register?time=1734451522547" target="_blank" rel="noopener noreferrer">Loan Application</a></li>
    </div>

    <a href="https://www.strongfg.com" target="_blank" rel="noopener nonreferrer"><img src="images/sfg_logo.png" alt="Strong Financial Group, Inc. Logo" height="100px" width="auto"></a>
</footer>
